...
Les derniers champs permettent de définir un numéro d'ordre et une couleur pour gérer l'affichage dans certains outils de la plateforme comme le bulletin.
